...
# limit to those best-fit by gain/loss learning model
dt <- read.csv(here('output', 'model_comparison.csv'))
doublea <- dt[which(dt$win == 'double'), ]$id
rm(dt)

# baseline data ####
# read in fits to baseline sim data
b <- read.csv(here::here('output', 'simulation', sim_type, 'b_fit2_b.csv'))
a1 <- read.csv(here::here('output', 'simulation', sim_type, 'a1_fit2_b.csv'))
a1d <- read.csv(here::here('output', 'simulation', sim_type, 'a1d_fit2_b.csv'))
a2 <- read.csv(here::here('output', 'simulation', sim_type, 'a2_fit2_b.csv'))
a2d <- read.csv(here::here('output', 'simulation', sim_type, 'a2d_fit2_b.csv'))
a2p <- read.csv(here::here('output', 'simulation', sim_type, 'a2p_fit2_b.csv'))

# fix a2p
#a2p <- a2p[c(1:4, 9:11, 8)]
...
d2 <- merge(a2d[c(1,6:7)], a2p[c(1,8:9)], by = 'Subject', suffixes = c('_a2d', '_a2p'))
d3 <- merge(d,d1)
d4 <- merge(d3,d2)
rm(b,a1,a1d,a2,a2d,a2p,d,d1,d2,d3)

# limit to only gain-loss learners (comment out if need be)
d4$id <-str_split(d4$Subject, '_', simplify = TRUE)[,1]
d4 <- d4[which(d4$id %in% doublea),]
...
b <- read.csv(here::here('output', 'simulation', sim_type, 'b_fit2_b.csv'))
a1 <- read.csv(here::here('output', 'simulation', sim_type, 'a1_fit2_a1.csv'))
a1d <- read.csv(here::here('output', 'simulation', sim_type, 'a1d_fit2_a1.csv'))
a2 <- read.csv(here::here('output', 'simulation', sim_type, 'a2_fit2_a1.csv'))
a2d <- read.csv(here::here('output', 'simulation', sim_type, 'a2d_fit2_a1.csv'))
a2p <- read.csv(here::here('output', 'simulation', sim_type, 'a2p_fit2_a1.csv'))
...
b <- read.csv(here::here('output', 'simulation', sim_type, 'b_fit2_a1d.csv'))
a1 <- read.csv(here::here('output', 'simulation', sim_type, 'a1_fit2_a1d.csv'))
a1d <- read.csv(here::here('output', 'simulation', sim_type, 'a1d_fit2_a1d.csv'))
a2 <- read.csv(here::here('output', 'simulation', sim_type, 'a2_fit2_a1d.csv'))
a2d <- read.csv(here::here('output', 'simulation', sim_type, 'a2d_fit2_a1d.csv'))
a2p <- read.csv(here::here('output', 'simulation', sim_type, 'a2p_fit2_a1d.csv'))
...
b <- read.csv(here::here('output', 'simulation', sim_type, 'b_fit2_a2.csv'))
a1 <- read.csv(here::here('output', 'simulation', sim_type, 'a1_fit2_a2.csv'))
a1d <- read.csv(here::here('output', 'simulation', sim_type, 'a1d_fit2_a2.csv'))
a2 <- read.csv(here::here('output', 'simulation', sim_type, 'a2_fit2_a2.csv'))
a2d <- read.csv(here::here('output', 'simulation', sim_type, 'a2d_fit2_a2.csv'))
a2p <- read.csv(here::here('output', 'simulation', sim_type, 'a2p_fit2_a2.csv'))
...
b <- read.csv(here::here('output', 'simulation', sim_type, 'b_fit2_a2d.csv'))
a1 <- read.csv(here::here('output', 'simulation', sim_type, 'a1_fit2_a2d.csv'))
a1d <- read.csv(here::here('output', 'simulation', sim_type, 'a1d_fit2_a2d.csv'))
a2 <- read.csv(here::here('output', 'simulation', sim_type, 'a2_fit2_a2d.csv'))
a2d <- read.csv(here::here('output', 'simulation', sim_type, 'a2d_fit2_a2d.csv'))
a2p <- read.csv(here::here('output', 'simulation', sim_type, 'a2p_fit2_a2d.csv'))
...
b <- read.csv(here::here('output', 'simulation', sim_type, 'b_fit2_a2p.csv'))
a1 <- read.csv(here::here('output', 'simulation', sim_type, 'a1_fit2_a2p.csv'))
a1d <- read.csv(here::here('output', 'simulation', sim_type, 'a1d_fit2_a2p.csv'))
a2 <- read.csv(here::here('output', 'simulation', sim_type, 'a2_fit2_a2p.csv'))
a2d <- read.csv(here::here('output', 'simulation', sim_type, 'a2d_fit2_a2p.csv'))
a2p <- read.csv(here::here('output', 'simulation', sim_type, 'a2p_fit2_a2p.csv'))
