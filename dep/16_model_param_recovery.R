...
# # baseline model - done ####
# # read data in
# bld <- read.csv(here::here('output', 'simulation', sim_type, 'sim_baseline_model_data.csv'))
# blf <- read.csv(here::here('output', 'simulation', sim_type, 'b_fit2_b.csv'))
...
# # 1a model - done ####
# # read data in
# ad <- read.csv(here::here('output', 'simulation', sim_type, 'sim_1alpha_model_data.csv'))
# af <- read.csv(here::here('output', 'simulation',  sim_type, 'a1_fit2_a1.csv'))
...
# # 1a decay model - done ####
# # read in data
# add <- read.csv(here::here('output', 'simulation',  sim_type, 'sim_1alpha_decay_model_data.csv'))
# add <- add[which(add$Trial == 1), ] # 1a decay model
# adf <- read.csv(here::here('output', 'simulation',  sim_type, 'a1d_fit2_a1d.csv'))
# # clean up and merge 
...
# read in data
gld <- read.csv(here::here('output', 'simulation',  sim_type, 'sim_2alpha_model_data.csv'))
gld <- gld[which(gld$Trial == 1), ] # 2a model
glf <- read.csv(here::here('output', 'simulation',  sim_type, 'a2_fit2_a2.csv'))

# limit to only gain-loss learners (comment out if need be)
gld$id <-str_split(gld$Subject, '_', simplify = TRUE)[,1]
gld <- gld[which(gld$id %in% doublea),]

glf$id <-str_split(glf$Subject, '_', simplify = TRUE)[,1]
glf <- glf[which(glf$id %in% doublea),]
...
# # 2a decay model ####
# # read in data
# gldd <- read.csv(here::here('output', 'simulation',  sim_type, 'sim_2alpha_decay_model_data.csv'))
# gldd <- gldd[which(gldd$Trial == 1),] # 2a with decay
# gldf <- read.csv(here::here('output', 'simulation',  sim_type, 'a2d_fit2_a2d.csv'))
# # clean up and merge
...
# # 2a prior model ####
# # read in data
# glpd <- read.csv(here::here('output', 'simulation',  sim_type, 'sim_2alpha_with_priors_model_data.csv'))
# glpd <- glpd[which(glpd$Trial == 1),] # 2a with priors
# glpf <- read.csv(here::here('output', 'simulation',  sim_type, 'a2p_fit2_a2p.csv'))
# # clean up and merge
