...
for i = 1:length(part)
     ...
     clear j
     fname = join([socialAL, '/output/eventfiles/rl/', part{i}, '/', part{i}, '_feedback_rpe.mat']);
     ...
     fname = join([socialAL, '/output/eventfiles/rl/', part{i}, '/', part{i}, '_decision_prob.mat']);
     save(fname, 'names', 'durations', 'onsets', 'pmod');
     clear fname names durations onsets
end
