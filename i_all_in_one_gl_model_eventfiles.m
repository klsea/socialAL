...
for i = 1:length(part)
     ...
     pmod(1).poly = {[1]};
     fname = join([socialAL, '/output/eventfiles/gl2/', part{i}, '/', part{i}, '_feedback_rpe.mat']);
     ...
     fname = join([socialAL, '/output/eventfiles/gl2/', part{i}, '/', part{i}, '_decision_prob.mat']);
     save(fname, 'names', 'durations', 'onsets', 'pmod');
